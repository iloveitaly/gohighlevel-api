...
```python
from ghl_client import AuthenticatedClient
...
```python
from ghl_client.models import MyDataModel
from ghl_client.api.my_tag import get_my_data_model
from ghl_client.types import Response
...
1. Any endpoint which did not have a tag will be in `ghl_client.api.default`
