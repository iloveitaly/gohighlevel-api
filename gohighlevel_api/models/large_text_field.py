...
T = TypeVar("T", bound="LargeTextField")
...
class LargeTextField:
    ...
    Attributes:
        ...
        field_value (str | Unset):  Example: My Text.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        large_text_field = cls(
            id=id,
            field_value=field_value,
            key=key,
        )

        large_text_field.additional_properties = d
        return large_text_field
