...
from ...models.create_note_version import CreateNoteVersion
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = GetCreateUpdateNoteSuccessfulResponseDto.from_dict(response.json())
