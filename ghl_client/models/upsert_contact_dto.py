...
T = TypeVar("T", bound="UpsertContactDto")
...
class UpsertContactDto:
    ...
    Attributes:
        ...
        company_name (None | str | Unset):  Example: DGS VolMAX.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upsert_contact_dto.additional_properties = d
        return upsert_contact_dto
